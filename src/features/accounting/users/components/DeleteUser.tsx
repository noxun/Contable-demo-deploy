...
import {IUserResponse, userId} from "@/features/accounting/users/types/users"
import {deleteUserAPI} from "@/features/accounting/users/lib/user"
...
export const DeleteUser = ({userToDelete, onCloseDialog, token}: Props) => {
    ...
    if (isError) {
        return (<span>Ocurrio un error al eliminar el usuario...</span>)
    }
