...
export const FormFixedAssets = ({ defaultValueForm, mode, idAsset }: Props) => {
  ...
  const onSumbit = (data: SchemaFixedAsset) => {
    ...
    if (mode === "edit" && idAsset) return editMutation.mutate({ IdAssets: idAsset, fixedAsset: data })
  }
        ...
        >
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className='flex flex-col' >
                  ...
                  <ListAssetsSelect value={field.value} onChange={(value) => field.onChange(value)} />
                </FormItem>
              )}
            />
          ...
          <div className="flex md:gap-8 w-full gap-2 md:flex-row flex-col">
            ...
            <div className='basis-2/3 flex flex-col items-end gap-4'>
              ...
              />
              <Button className="flex items-center justify-center gap-2" disabled={createMutation.isPending}>
                <Save size={20} />{
